...
#### Adjust elasticies to average wage variation  
...
Using all the components descbribed above we get $\widehat{ \Delta^{-} E } =$ `r round(delta.e1*1000)` thousand jobs. The report however computes $F_{adjs}$ in a different fashion and gets a value of 4.5[^2]. Plugging this value into the equation above one gets $\widehat{ \Delta^{-} E } =$ `r round(delta.e2*1000)` thousand jobs. 
