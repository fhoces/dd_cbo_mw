...
# Introduction  
This (living) document is a reader companion to the report form the Congressional Budget Office titled ["The Effects of a Minimum-Wage Increase on Employment and Family Income"](https://www.cbo.gov/publication/44995). Our purposes are twofold: (i) demonstrate how new scientific practices of transparency and reproducibilty (T & R) can be applied to policy analysis and (ii) promote the technical discussion around a recurrent policy issue (minimum wage) by making explicit and visible all the components (e.g. data, codes, methods) and key assumptions of the most up-to-date official policy analysis on the matter. We encourage readers to collaborate in this document and help develop an ever-improving version of the important policy estimates[^3] (re)produced here.
...
<a id="displayText" href="javascript:toggle(5);">Code</a>  
