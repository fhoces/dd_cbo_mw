---
title: |-
  Reader Companion for CBO report on Min Wage
...
#png("sample_pref.png")
quartz()
plot(seq(-1/4,1/5,by = 0.01),sapply(seq(-1/4,1/5,by = 0.01) ,final_dec.f), type = "l", xlab = "rho", ylab = "W (billions of $)  ", main = NULL, axes=F)
#axis(side=1, at=c(-0.2, -0.1,0,0.1, 0.2), labels=c("-0.2", "Dislikes","0","Likes", "0.2"))
...
<div class="jumbotron">
  <p>Final replication output (Nothing on "learn more". Will direct to github/shiny app)</p>  
