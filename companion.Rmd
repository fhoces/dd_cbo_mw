...
author: "Fernando Hoces de la Guardia + (hopefully) a lot of other people"
...
```{r loading data, eval=TRUE,echo=display_code, warning=FALSE, message=FALSE}
