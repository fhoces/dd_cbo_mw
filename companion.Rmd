...
AQUI VOY: make it visisble in R and translate it in to Stata
...
```{r Universe, eval=TRUE,echo=display_code, warning=FALSE, message=FALSE, results="hide", error=FALSE, collapse=TRUE, fig.show='hold'}
...
For the universe of interest, we describe the distribution of hourly wages in 2013 and the forecast values for 2016. Figure 2.    
