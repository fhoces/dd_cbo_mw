...
# SAME
df$w3.adj.min <- with( df, ifelse(w3.adj1> st.minw.2016[state,] * param.states.raise,
                              w3.adj1,
                              st.minw.2016[state,] * param.states.raise) )
...
df$wage.adj.min <- with( df, ifelse(wage.adj1> st.minw.2016[state,] * param.states.raise,
                              wage.adj1,
                              st.minw.2016[state,] * param.states.raise) )
