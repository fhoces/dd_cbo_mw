...
In 2014 the Congressional Budget Office published the report titled ["The Effects of a Minimum-Wage Increase on Employment and Family Income"](https://www.cbo.gov/publication/44995). The report receive wide attention from the media and has been used extensible as an input in the debate around the minimum wage[^3]. This report represents the    AQUI VOYAlthough there was some disagreement among experts around some technical issues, this disagrement has been mainly circunscribed around one of the many inputs used in the analysis. 
