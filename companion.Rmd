...
param.ripple <- c("scope_below" = 8.7, "scope_above" = 11.5*1.0, "intensity" = 0.5*1.0)
...
#png("sample_pref.png")
plot(seq(-1/4,1/5,by = 0.01),sapply(seq(-1/4,1/5,by = 0.01) ,final_dec.f), type = "l", xlab = "rho", ylab = "FE (billions of $)  ", main = "Final effect of minimum wage raises \nfor different redistributory preferences")
